...
public class PositionImageHolder extends android.support.v7.widget.AppCompatImageView {
    ...
    public PositionImageHolder(Context context) {
        this(context, null, 0);
    }

    public PositionImageHolder(Context context, AttributeSet attrs) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (!mScaleDetector.isInProgress()) {
                    ...
                    Log.d(LOG_TAG, "mPosX: " + mPosX + " | mPosY: " + mPosY);
